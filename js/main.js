    ...
    initPriceRange: () => {
        $('#slider-range').slider({
            ...
            slide: function (event, ui) {
                $('#amount').val('Từ: ' + ui.values[0].toLocaleString('it-IT', {}) + 'đ - ' + ui.values[1].toLocaleString('it-IT', {}) + 'đ');
            }
        });
        $('#amount').val('Từ: ' + $('#slider-range').slider('values', 0).toLocaleString('it-IT', {}) + 'đ - ' + $('#slider-range').slider('values', 1).toLocaleString('it-IT', {}) + 'đ');
    },
    initDropdown: () => {
    ...
    handleShowHideFormSign: () => {
        $(document).ready(function () {
            $('.show_sign_up').click(function () {
                ...
                $('.login__content').hide();
                $('.login_distributor_content').hide();
            });
            ...
            $('.show_sign_distributor').click(function () {
                $('.login_distributor_content').show();
                $('.register_content').hide();
                $('.login__content').hide();
            });
        });
